          ...
          {devs.map((dev, idx) => (
            <div className="one-dev">
              ...
              <div className="dev-links">
                <a className='dev-link' target='_blank' href={dev.gitHub} rel='noreferrer'><BsGithub size={35} /></a>
                <a className='dev-link' target='_blank' href={dev.linkedIn} rel='noreferrer'><BsLinkedin size={35} /></a>
              </div>
            </div>
          ))}
        </div>
