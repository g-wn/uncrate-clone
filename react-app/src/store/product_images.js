...
export const getAllProductImages = (state) => Object.values(state.product_images);
...
const productImagesReducer = (state = initialState, action) => {
    switch (action.type) {
        case LOAD_PRODUCT_IMAGES:
            return action.product_images.Product_Images.reduce((product_images, product_image) => {
