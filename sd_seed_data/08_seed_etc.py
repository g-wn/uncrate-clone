[
  {
    ...
    "detailedDescription": """For the Vintage Tent Fabric Pet Bed, not only are the materials repurposed but so is the design. The shape is inspired by cloth buckets soldiers laid down when taking showers outside. It's handmade using old tents sold by the military, giving it a worn, utilitarian look. Due to the reclaimed nature of the fabric, the product may show slight imperfections and color differences, giving each piece its own unique character.
  ...
  },
  {
    ...
    "description": "This self-explanatory title gives you the precut pieces and instsructions needed to build a life-size skeleton. $40.",
    "detailedDescription": """It's appropriate Halloween decor, to be sure, but the rack of bones that comes out of Build Your Own Skeleton is useful for more than just decoration. Each life-size piece is precut, so all that's needed to assemble the skeleton is some folding and instruction-following. The joints are bendable, the parts are anatomically labeled in both English and Latin, and the result is a full-size human ready for posing, staging, or study.
