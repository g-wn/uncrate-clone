[
  ...
  },
  {
    ...
    "detailedDescription": """Inspired by the darkness of night, It's OK's latest cassette player is a sleek way to enjoy your legacy media. Bluetooth 5.0 support lets it play nice with modern wireless headphones and speakers, while a built-in mic lets you record your thoughts to the included blank tape. Alongside the playback controls, you'll find a physical volume wheel, sliding power switch, and 3.5mm headphone jack, as well as a detachable belt clip and a transparent black cover to offer a view of the currently playing selection.

    Requires 2 AA Batteries / Supports Type I Cassette Tapes
