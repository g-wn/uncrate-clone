[
  ...
  },
  {
    ...
    "detailedDescription": "It looks like the kind of pipe your granddad (or maybe great-grandad) might have smoked. Yet this model from Hemson hides modern convenience. The American ash wood body is carved by hand into a timeless silhouette, but fitted with a removable glazed ceramic bowl and filter screen for easier cleaning and a more enjoyable smoke. The body undergoes a multi-step polishing, tinting, and waxing process that gives it a handsome, durable black finish that will develop a unique patina over time. Finished with a removable, co-injected acrylic/nylon mouthpiece.",
    "categoryId": 6,
    "price": 90.00,
    "productImgId": 62,
  },
  ...
  },
  {
    ...
    "detailedDescription": """Sometimes minor swaps totally transform a drink. The shift in spirit and citrus in the Final Ward from Phil Ward brings a calming vanilla of whiskey and a rounded out splash of brightness from lemon juice. Equal parts cocktails are tough to balance, but this is a masterclass.
